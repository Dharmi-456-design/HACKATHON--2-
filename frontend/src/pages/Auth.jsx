      ...
      <AnimatePresence>
        {googleBusy && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#07130E]/90 backdrop-blur-xl text-white p-6"
          >
            <div className="relative flex items-center justify-center mb-6">
              <div className="w-16 h-16 rounded-full border-4 border-[#96CD7B]/30 border-t-[#96CD7B] animate-spin" />
              <svg className="w-8 h-8 absolute" viewBox="0 0 24 24">
            ...
            <h3 className="text-xl font-bold tracking-wide mb-2 text-white">Connecting to Google...</h3>
            <p className="text-xs text-emerald-200/70 text-center max-w-xs">
              Authenticating with Google Account to sync your NaturePulse passport.
            </p>
          </motion.div>
        )}
      </AnimatePresence>
